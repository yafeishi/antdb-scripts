...
SET COORDINATOR ALL (log_min_duration_statement = 0 );
SET COORDINATOR ALL (log_connections = on );
SET COORDINATOR ALL (log_disconnections = on);
SET COORDINATOR ALL (log_duration = on);
SET COORDINATOR ALL (log_statement = 'none' );
...
SET COORDINATOR ALL (wal_level='hot_standby');
...
SET COORDINATOR ALL (checkpoint_timeout = '20min');
...
SET DATANODE ALL (log_duration = on);
SET DATANODE ALL (log_statement = 'all' );
...
SET DATANODE ALL (checkpoint_timeout = '20min' );
