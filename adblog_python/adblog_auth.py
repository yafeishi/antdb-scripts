...
;
"""
    copy_line = 'then execute "copy adblog_auth from \''+outcsvfilename+'\'  delimiter \''+out_delimiter+'\' csv;" to load csv data '
...
def get_logrange_input():
    ...
    outcsvfilename = os.getcwd()+'/adblog_auth_'+nodename+'_'+begintime+'_'+endtime+'.csv'
